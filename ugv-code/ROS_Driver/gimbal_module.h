...
float panAngleCompute(int inputPos) { return mapFloat((inputPos - 2047), 0, 4095, 0, 360); }

float tiltAngleCompute(int inputPos) { return mapFloat((2047 - inputPos), 0, 4095, 0, 360); }
